...
const testimonials = [
  {
    ...
    name: "Imran Hashmi",
    role: "CEO, LuxTime",
    message: "The watches and jewelry are absolutely exquisite. The quality and attention to detail are unmatched.",
  },
  {
    id: 2,
    name: "Kamran Ghulam",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-amber-200/70 mt-2">
            What our clients are saying about our watches and jewelry.
          </p>
        </div>
