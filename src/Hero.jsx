        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 lg:pt-20 pb-16 sm:pb-24 lg:pb-32">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              >
                Discover exquisite timepieces and fine jewelry crafted with unparalleled precision. Each piece tells a story of elegance, sophistication, and timeless beauty.
              </motion.p>
              ...
              >
                ...
                <button className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-amber-500/50 text-amber-100 font-semibold rounded-lg hover:bg-amber-500/10 hover:border-amber-400 transition-all duration-300">
                  View Jewelry
                </button>
              </motion.div>
